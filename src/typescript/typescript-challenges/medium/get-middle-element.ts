...
type myGetMiddleElement<
  T extends any[],
  Res extends any[] = [],
> =
  T extends [infer first, ...infer middle, infer _]
  ? [...middle]["length"] extends 2
  ? myGetMiddleElement<middle, [first, ...middle]>
  : myGetMiddleElement<middle, [...middle]>
  : Res;
